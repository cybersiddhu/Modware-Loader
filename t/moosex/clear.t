...

{
    ...
    has 'unstable' =>
        ( is => 'rw', isa => 'Str', traits => [qw/ClearAfterAccess/] );
...
is( $ga->stable, 'stay',
    'attribute stable has the correct value after the access' );
is( $ga->unstable, undef,
    'attribute unstable is undefined after the access' );
